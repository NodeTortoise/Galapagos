(function() {
  ...
  window.EditorWidget = Ractive.extend({
    onrender: function() {
      window.editor = CodeMirror(this.find('.netlogo-code'), {
        value: this.get('code'),
        tabSize: 2,
        mode: 'netlogo',
      ...
      return editor.on('change', (function(_this) {
        return function() {
          return _this.set('code', editor.getValue());
        };
      })(this));
    },
